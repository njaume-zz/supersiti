...
CREATE TABLE [dbo].[V_CAJAS_ESTADO](
...
CREATE TABLE [dbo].[V_CAJAS](
	...
	PRIMARY KEY ([CAJ_ID]),
	CONSTRAINT [FK_CAJAS_ESTADOS_CAJA] FOREIGN KEY ([CAE_ID]) REFERENCES [V_CAJAS_ESTADO] ([CAE_ID])
)
...
CREATE TABLE [dbo].[C_RUBRO](
	...
	PRIMARY KEY ([RUB_ID]),
	CONSTRAINT [PK_RUBRO_FAMILIA] FOREIGN KEY ([FAM_ID]) REFERENCES [C_FAMILIA] ([FAM_ID])
)
...
CREATE TABLE [dbo].[C_PRODUCTO](
	...
	PRIMARY KEY ([PRO_ID]),
	CONSTRAINT [PK_PRODUCTO_UNIDAD_COMPRA] FOREIGN KEY ([UNC_ID]) REFERENCES [C_UNIDADES] ([UNI_ID]),
	CONSTRAINT [PK_PRODUCTO_UNIDAD_VENTA] FOREIGN KEY ([UNV_ID]) REFERENCES [C_UNIDADES] ([UNI_ID]),
