...
BEGIN
	BEGIN TRANSACTION
		INSERT INTO C_LISTA_PRECIO(LPR_ID,PRO_ID,TPR_ID,LPR_PRECIO,LPR_PRECIOXCANTIDAD,LPR_ESTADO,LPR_FECHAALTA)
		 VALUES (@LPR_ID,@PRO_ID,@TPR_ID,@LPR_PRECIO,@LPR_PRECIOXCANTIDAD,@LPR_ESTADO,GETDATE())
		 SET @LPR_ID= @@IDENTITY
		IF (@@ERROR != 0)
		BEGIN
			SELECT @@ERROR
