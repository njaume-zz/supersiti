...
ALTER  PROCEDURE [dbo].[STR_CONSULTA_PRODUCTO](
	@PRO_ID AS INT =0,
	@PRO_CODIGO AS VARCHAR(20)='',
	@PRO_NOMBRE AS VARCHAR(250)='',
	@PRO_MARCA AS VARCHAR(100)='',
...
BEGIN
	...
	SELECT PROD.PRO_ID,PROD.PRO_CODIGO,PROD.PRO_CODIGO_BARRA,PROD.PRO_CODIGO_PROVEEDOR,PROD.PRO_NOMBRE,
		...
		PROD.PRO_IMPUESTOINTERNO,PROD.PRO_IDPADRE,PROD.PRO_MINIMO,PROD.PRO_MAXIMO,
		PROD.PRO_ALERTA,RUBRO.RUB_NOMBRE,FAMILIA.FAM_NOMBRE,RUBRO.RUB_ID,IMI.IVA_NOMBRE,IMI.IVA_TASA,
		LPR.LPR_PRECIO
		...
		ON PROD.PRO_IVA = IMI.IVA_ID INNER JOIN C_LISTA_PRECIO LPR
		ON LPR.PRO_ID = PROD.PRO_ID INNER JOIN C_TIPOS_PRECIOS TPR
