...
Module mdlFiscal
    ...
    Private Structure tCliente
        Public Id As String
        'Public IdTipo As TiposDeDocumento
        Public Detalle As String
        Public ResponsabilidadId As String
        Public Domicilio As String
        Public IngresosBrutos As String
        Public CUIT As String

    End Structure

    Private Structure tComprobante
        Public Tipo As eComprobante
    ...
    Private Structure ComprobanteFiscal
        Public Cliente As tCliente
        Public Comprobante As tComprobante
        Public Pagos() As tPagos
        Public Cajero As Integer
        Public NumeroDevuelto As String
        Public ErrorMensaje As String
        Public OK As Boolean
        Public rstItems As DataTable ' new ADODB.Recordset
        Public frmFormulario As Form
        Public arrDatosIva As String
    End Structure
    ...
    '        ByVal rstItemsArti As DataTable, _
