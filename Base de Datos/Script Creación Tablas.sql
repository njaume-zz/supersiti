...
CREATE TABLE [dbo].[V_COMPROBANTE](
	...
	[COM_FORMAPAGO] [VARCHAR] (20), -- O PUEDE SER UN CHAR
	[COM_IMPORTEGRAVADO][NUMERIC] (18,2),
	[COM_IMPORTENOGRAVADO][NUMERIC](18,2),
	[COM_IVAFACTURADO] [NUMERIC] (18,2),
	[COM_TOTALFACTRADO] [NUMERIC] (18,2),
	[COM_IMPRESO] [CHAR](1),	-- DETERMINA SI SE IMPRIMIÓ EL COMPROBANTE
	[CLI_ID] [INT],	-- CONVIENE PONER TODOS LOS DATOS DEL CLIENTE?
	[CTC_ID] [INT], 
